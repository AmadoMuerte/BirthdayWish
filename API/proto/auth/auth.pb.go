...
func (x *SignInResponse) GetExp() int64 {
	if x != nil {
		return x.Exp
	}
	return 0
...
const file_auth_proto_rawDesc = "" +
	...
	"\x03exp\x18\x05 \x01(\x03R\x03exp2w\n" +
	"\vAuthService\x123\n" +
	"\x06SignUp\x12\x13.auth.SignUpRequest\x1a\x14.auth.SignUpResponse\x123\n" +
	"\x06SignIn\x12\x13.auth.SignInRequest\x1a\x14.auth.SignInResponseB\tZ\a../authb\x06proto3"
